						...
						<div class="forms">
							<div class=" form-grids form-grids-right">
								<div class="widget-shadow " data-example-id="basic-forms"> 
									...
									<div class="form-body">
										<form class="form-horizontal" action="next1.jsp"> 
											...
											<div class="form-group"> 
												...
												<div class="col-sm-9"> 
													<input type="text" name="year" class="form-control" id="inputEmail3" placeholder="ex.2022-23"> 
												</div> 
											</div>  
									
			                                   <div class="col-sm-offset-2"> 
												<button type="submit" class="btn btn-default w3ls-button">Generate</button> 
											</div> 
										</form> 
									</div>
								</div>
